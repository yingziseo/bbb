            ...
            <el-form-item label="网页 ICO 图标" class="md:col-span-2">
              <div class="grid w-full gap-3 sm:grid-cols-[72px_1fr]">
                <div class="flex h-[72px] w-[72px] items-center justify-center border border-[var(--color-line)] bg-[var(--color-panel)] p-2">
                  <img :src="form.faviconPath || '/favicon.ico'" alt="网页图标预览" class="max-h-full max-w-full object-contain" />
                </div>
                <div class="min-w-0">
                  ...
                  <div class="mt-2 flex flex-wrap items-center gap-3">
                    ...
                    >
                      <el-button :loading="uploadLoading === 'faviconPath'">上传替换 ICO 图标</el-button>
                    </el-upload>
                    <span class="text-[12px] text-[var(--color-slate-muted)]">当前默认使用 /favicon.ico，网页头部只声明这一处图标。</span>
                  </div>
                </div>
              </div>
            </el-form-item>
