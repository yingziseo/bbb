...
export const mapPost = (row: any) => ({
  ...
  publishedBySchedulerAt: row.published_by_scheduler_at || '',
...
export const mapInquiry = (row: any) => ({
  ...
  mailLastEvent: row.mail_last_event || '',
  mailLastEventAt: row.mail_last_event_at || '',
  mailLastCheckedAt: row.mail_last_checked_at || '',
  mailCheckError: row.mail_check_error || '',
